...
import com.rochatec.pos.athena.app.ApplicationController;
...
public class WelcomeView extends ViewPart {
	...
	private Form form;
	protected ApplicationController controller = Activator.getDefault().getController();
	...
	public void createPartControl(Composite parent) {
		...
		header.setText(Message.getMessage("label.boxStatus."+ controller.getStatus().name()));
