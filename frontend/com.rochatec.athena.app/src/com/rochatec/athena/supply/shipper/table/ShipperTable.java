package com.rochatec.athena.supply.shipper.table;
...
public class ShipperTable extends AbstractTable{

	public ShipperTable(Composite parent) {
		super(parent);
	}
	...
	protected void buildCollumns(TableViewer tableViewer) {
		...
		id.getColumn().setText(Messages.getMessage("shipper.field.label.id"));
		...
		socialSecurity.getColumn().setText(Messages.getMessage("shipper.field.label.socialSecurity"));
		...
		businessName.getColumn().setText(Messages.getMessage("shipper.field.label.businessName"));
		...
		tradeName.getColumn().setText(Messages.getMessage("shipper.field.label.tradeName"));
		...
		registerNumber.getColumn().setText(Messages.getMessage("shipper.field.label.registerNumber"));
		...
		dateRegister.getColumn().setText(Messages.getMessage("shipper.field.label.dateRegister"));
		...
		street.getColumn().setText(Messages.getMessage("shipper.field.label.street"));
		...
		streetNumber.getColumn().setText(Messages.getMessage("shipper.field.label.streetNumber"));
		...
		zipCode.getColumn().setText(Messages.getMessage("shipper.field.label.zipcode"));
		...
		neighborhood.getColumn().setText(Messages.getMessage("shipper.field.label.neighborhood"));
		...
		city.getColumn().setText(Messages.getMessage("shipper.field.label.city"));
		...
		province.getColumn().setText(Messages.getMessage("shipper.field.label.province"));
		...
		status.getColumn().setText(Messages.getMessage("shipper.field.label.status"));
