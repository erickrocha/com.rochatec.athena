package com.rochatec.athena.manufacture.abstractproduct.table;
...
public class AbstractProductTable extends AbstractTable{

	public AbstractProductTable(Composite parent) {
		super(parent);
	}
	...
	protected void buildCollumns(TableViewer tableViewer) {
		...
		stock.getColumn().setText(Messages.getMessage("product.field.label.column.stock"));
