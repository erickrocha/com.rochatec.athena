package com.rochatec.athena.manufacture.productSet.table;
...
public class ProductSetTable extends AbstractTable{

	public ProductSetTable(Composite parent) {
		super(parent);
	}
	...
	protected void buildCollumns(TableViewer tableViewer) {
		...
		id.getColumn().setText(Messages.getMessage("productset.field.label.id"));
		...
		category.getColumn().setText(Messages.getMessage("productset.field.label.category"));
		...
		name.getColumn().setText(Messages.getMessage("productset.field.label.name"));
		...
		unitMeasure.getColumn().setText(Messages.getMessage("productset.field.label.unitmeasure"));
		...
		stock.getColumn().setText(Messages.getMessage("productset.field.label.stock"));
		stock.getColumn().setWidth(120);
		...
		costPrice.getColumn().setText(Messages.getMessage("productset.field.label.costPrice"));
		costPrice.getColumn().setWidth(120);
		...
		sellPrice.getColumn().setText(Messages.getMessage("productset.field.label.sellPrice"));
		...
		icms.getColumn().setText(Messages.getMessage("productset.field.label.icms"));
		...
		ipi.getColumn().setText(Messages.getMessage("productset.field.label.ipi"));
		...
		active.getColumn().setText(Messages.getMessage("productset.field.label.status"));
